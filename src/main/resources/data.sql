...
VALUES(0, '2026-02-02', 'aasdasd', 'asdasdasd', '2026-02-02', '5641323156', 0, 'anketa', '2026-02-02', 0, 'hi');
INSERT INTO tech9survey.survey
(id, creation_date, description, exit_message, expiration_date, hashed_id, is_active, `name`, publication_date, user_id, welcome_message)
VALUES(0, '2026-02-02', 'aasdasd', 'asdasdasd', '2026-02-02', '5641243156', 0, 'anketa', '2026-02-02', 0, 'hi');
INSERT INTO tech9survey.survey
(id, creation_date, description, exit_message, expiration_date, hashed_id, is_active, `name`, publication_date, user_id, welcome_message)
VALUES(0, '2026-02-02', 'aasdasd', 'asdasdasd', '2026-02-02', '5641223156', 0, 'anketa', '2026-02-02', 0, 'hi');